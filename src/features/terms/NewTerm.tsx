            ...
            await createTermMutation.mutateAsync(payload, {
                ...
                onError: (err: any) => {
                    show(
                        "error",
                        "Creation Error",
                        err?.message || "Failed to create new term record, please try again."
                    );
                },
            });
        } catch (err) {
            show("error", "Creation Error", (err as any)?.message || "Failed to create term.");
        }
    };

    const loading = createTermMutation.isPending;
