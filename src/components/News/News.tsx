...
const NEWS_ITEMS = [
    ...
    },
    {
        ...
        date: "October 5, 2025",
        description:
            "The Sanitation Club is organizing a school-wide clean-up drive to promote environmental awareness. All students are encouraged to participate in this community-building initiative.",
        image: (images as any).student7,
