...
import { FaPhone, FaEnvelope, FaMapMarkerAlt, FaGraduationCap } from 'react-icons/fa';
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
                    ...
                    >
                        <div className="flex items-center gap-3 mb-6">
                            <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-cyan-500 p-2 rounded-full flex items-center justify-center">
                                <FaGraduationCap className="text-xl w-12 h-12 text-white" size={16} />
                            </div>
                            <div>
                                <h3 className="text-2xl font-bold">Habnaj International Schools</h3>
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center gap-3 text-gray-300">
                                ...
                                <span className="text-sm">Plot D12, Sam Njoma Street, GRA, Bauchi, Bauchi State, Nigeria</span>
                            </div>
                            <div className="flex items-center gap-3 text-gray-300">
                                <FaPhone className="text-green-400 flex-shrink-0" />
                                <span className="text-sm">+234 905 498 5027</span>
                            </div>
                            <div className="flex items-center gap-3 text-gray-300">
                                <FaEnvelope className="text-red-400 flex-shrink-0" />
                                <span className="text-sm">habnaj2021international@gmail.com</span>
                            </div>
                        </div>
                    </motion.div>
                ...
                <div className="container mx-auto px-4 py-6">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        ...
                        <motion.p
                            ...
                            viewport={{ once: true }}
                        >
                            © {currentYear} Habnaj International Schools. All rights reserved. |
